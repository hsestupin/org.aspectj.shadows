...
public class BatchFilerImpl implements Filer {
	...
	public JavaFileObject createClassFile(CharSequence name,
		...
		fileCreated("createClassFile", uri);
	...
	public FileObject createResource(Location location, CharSequence pkg,
		...
		fileCreated("createResource", uri);
		return fo;
	}

	private boolean fileCreated(String description, URI uri) {
		_env.getMessager().printMessage(Diagnostic.Kind.NOTE, description + " -- add uri " + uri);
		return _createdFiles.add(uri);
	}
	...
	public JavaFileObject createSourceFile(CharSequence name,
		...
		fileCreated("createSourceFile", uri);
