		...
		implements IProcessorProvider 
{
	...
	public void processAnnotations(CompilationUnitDeclaration[] units, ReferenceBinding[] referenceBindings, boolean isLastRound) {
		...
		if (isLastRound) {
			_processingEnv._messager.printMessage(Diagnostic.Kind.NOTE, "Last round!! roundEnv.getRootAnnotations() = " + roundEnv.getRootAnnotations());
		} else {
			_processingEnv._messager.printMessage(Diagnostic.Kind.NOTE, "Not last yet. roundEnv.getRootAnnotations() = " + roundEnv.getRootAnnotations());
		}
